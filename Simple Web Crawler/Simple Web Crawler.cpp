...
int main()
{
    ...
    string s1 = "https://www.tofugu.com/learn-japanese/";
    string s2 = "https://github.com/";
    string s3 = "https://codeforces.com/";

    thread t1(dfs_crawler, s1.c_str(), filename, 0, 1);
    thread t2(dfs_crawler, s2.c_str(), filename, 0, 2);
    thread t3(dfs_crawler, s3.c_str(), filename, 0, 3);
